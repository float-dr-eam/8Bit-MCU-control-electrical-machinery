...
{	
	...
	KEYCON1 = C_KCHS0;		 //0.5VDD,FRES/4，通道1	
	...
	#ifdef	C_KEY_2
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS1;		 //0.5VDD,FRES/4，通道2	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");
	...
	#ifdef	C_KEY_3
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS2;		 //0.5VDD,FRES/4，通道3	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");
	...
	#ifdef	C_KEY_4
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS3;		 //0.5VDD,FRES/4，通道4	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");
	...
	#ifdef	C_KEY_5
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS4;		 //0.5VDD,FRES/4，通道5	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");
	...
	#ifdef	C_KEY_6
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS5;		 //0.5VDD,FRES/4，通道6	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");
	...
	#ifdef	C_KEY_7
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS7;		 //0.5VDD,FRES/4，通道7	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");

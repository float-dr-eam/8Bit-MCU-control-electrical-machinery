...
#define			I2C_SCL			RA0
#define			I2C_SDA			RA1
volatile bit  	I2C_SCL_IO		@((unsigned)&TRISA*8)+0;		//IB口方向设置
volatile bit  	I2C_SDA_IO		@((unsigned)&TRISA*8)+1;		//IB口方向设置
...
#define		C_LVBO_SYS2		0x40		//fsys/3
#define		C_LVBO_SYS3		0x60		//fsys/4
#define		C_LVBO_SYS4		0x80		//fsys/5
#define		C_LVBO_SYS5		0xA0		//fsys/6
#define		C_LVBO_SYS6		0xC0		//fsys/7
#define		C_LVBO_SYS7		0xE0		//fsys/8


#define		C_LVBO			C_LVBO_SYS4


#define		C_KEYCON2		0X79//C_LVBO
